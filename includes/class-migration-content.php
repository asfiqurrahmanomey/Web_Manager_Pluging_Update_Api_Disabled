                    ...
                    foreach ($files as $key => $files_chunk) {
                        ...
                        if ($type == "wp-content") {
                            ...
                            if (WP_CONTENT_DIR == '/wp-content') {
                                ...
                                if (str_contains(WP_CONTENT_DIR, "../") or str_contains(WP_CONTENT_DIR, "./")) {
                                    $rmdir = str_contains(WP_CONTENT_DIR, ABSPATH) ? realpath( WP_CONTENT_DIR ) : realpath( ABSPATH . WP_CONTENT_DIR );
                                }
                            }
                        } else {
